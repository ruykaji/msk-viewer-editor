...
void selectPenAndBrush(const Rect::Material t_material, const double& t_lineWidth, QPainter* t_painter)
{
    ...
    case Rect::Material::M3: {
        t_painter->setPen(QPen(QColor(0, 0, 255), t_lineWidth, Qt::SolidLine, Qt::SquareCap));
        t_painter->setBrush(QBrush(QColor(0, 0, 255, 55), Qt::BDiagPattern));
        break;
    }
    ...
    case Rect::Material::M4: {
        ...
        t_painter->setBrush(QBrush(QColor(52, 252, 52, 55), Qt::FDiagPattern));
        break;
    }
    ...
    case Rect::Material::M5: {
        t_painter->setPen(QPen(QColor(0, 0, 255), t_lineWidth, Qt::SolidLine, Qt::SquareCap));
        t_painter->setBrush(QBrush(QColor(0, 0, 255, 55), Qt::HorPattern));
        break;
    }
    ...
    case Rect::Material::M6: {
        ...
        t_painter->setBrush(QBrush(QColor(128, 128, 128, 55), Qt::Dense3Pattern));
        break;
    }
